...
class Common_model extends CI_Model {
    ...
    public function getAllByTableName($table_name, $field = 'id', $order_type = 'ASC') {
        $this->db->select("*");
        $this->db->from($table_name);
        $this->db->order_by($field, $order_type);
        return $this->db->get()->result();
    }
    public function getAllByTableOrderByField($table_name,$field,$order) {
        $this->db->select("*");
        $this->db->from($table_name);
    ...
    public function getAllByTableByFieldOrderByField($table_name,$field_for_search, $field_value, $field_for_order = "id", $order_type = "ASC"){
        $this->db->select("*");
        $this->db->from($table_name);
        $this->db->where($field_for_search, $field_value);
        $this->db->order_by($field_for_order, $order_type);
        return $this->db->get()->result();   
    }
    ...
    public function deleteByFieldAndValue($table, $field, $value){
    ...
    public function getDataByFieldAndValue($table, $field, $value, $order_by_field = 'id', $order_type='ASC'){
        $this->db->select("*");
        $this->db->from($table);
        $this->db->where($field,$value);
        $this->db->order_by($order_by_field, $order_type);
        return $this->db->get()->result();
    }
